...
def GetAlpha3DSigMDistributions(gjetmcinput, gjetdatainput, outdir):
    
    NHistoInfos = OrderedDict()
    NHistoInfos["Data"] = [("1", "jet_Alpha3DSigM__NTRACK__Data",        "jet_Alpha3DSigM__NTRACK")]
    NHistoInfos["MC"]   = [
                           ("2", "jet_Alpha3DSigM__NTRACK__MC",          "jet_Alpha3DSigM__NTRACK"),
                           ("3", "jet_Alpha3DSigM__NTRACK__MCLightJet",  "jet_Alpha3DSigM__NTRACK__1+jet_Alpha3DSigM__NTRACK__21"),
                           ("4", "jet_Alpha3DSigM__NTRACK__MCBJet",      "jet_Alpha3DSigM__NTRACK__5+jet_Alpha3DSigM__NTRACK__19"),
                          ]
...
if __name__ == "__main__":
   ...
   mydir = myfile_save.mkdir("DAlpha3DSigM")
  
   GetAlpha3DSigMDistributions( options.gjetmcinput, options.gjetdatainput, mydir )   
